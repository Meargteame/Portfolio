export const experiences = [
  {
    ...
    description:
      "Founder & Tech Lead at Leons Lab (leonslab.tech). Architected full-stack applications 0-to-1, executing relational schema design, API security, and high-speed UI development. Reduced P99 latency by 45% using Redis caching and asynchronous job queues.",
